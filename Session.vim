...
badd +1 lib/comments
badd +31 lib/comments/comments_list_view.dart
...
badd +1 lib/repositories/story_repostitory.dart
...
badd +44 lib/stories/stories_list_view.dart
...
silent! normal! zE
let &fdl = &fdl
let s:l = 38 - ((28 * winheight(0) + 29) / 58)
...
wincmd w
argglobal
if bufexists(fnamemodify("~/personal/hacker_news/lib/stories/story_item.dart", ":p")) | buffer ~/personal/hacker_news/lib/stories/story_item.dart | else | edit ~/personal/hacker_news/lib/stories/story_item.dart | endif
if &buftype ==# 'terminal'
  silent file ~/personal/hacker_news/lib/stories/story_item.dart
endif
balt ~/personal/hacker_news/__FLUTTER_DEV_LOG__
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
silent! normal! zE
let &fdl = &fdl
let s:l = 43 - ((39 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 43
